...
echo Docker subiu com sucesso. Aguardando 15 segundos para inicialização dos serviços...
...
echo Aguardando 15 segundos para o Eureka estabilizar antes dos outros servicos...
timeout /t 15 /nobreak >nul
